 ...
 * State is client-side (localStorage via lib/cart.ts) until the CartModule
 * API lands; every control works now: qty steppers, remove, promo NANOS10,
 * live totals. Same-page traversing only — the single navigation is
      ...
      <div className="page">
        <div className="wrap">
          ...
          <div className="empty-state">
            ...
            <p>
              Looks like you haven&apos;t added anything yet. Browse crocs and
              trousers built for your everyday rotation.
            </p>
          ...
          <div className="cart-items">
            {cart.items.map((item) => (
              <div
                ...
                className="cart-line"
              >
                <Link href={`/product/${item.productId}`} className="cart-line-img">
                  <ImgOrSlot
                    src={item.img}
                    alt={item.name}
